...
# Model size
DEPTH = 4               # number of transformer layers (4 works well on MPS)
...
ckpt_path = os.path.join(os.path.expanduser("~"), ".cache", "autoresearch-quant", "model.pt")
torch.save({"model": model.state_dict(), "config": asdict(config), "val_bpb": val_bpb}, ckpt_path)
